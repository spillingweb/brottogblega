...
export const events: Event[] = [
  {
    ...
    host: "Kari Andersen & Ingrid Solberg",
    time: "10:00–16:00",
  ...
  },
  {
    ...
    spotsLeft: 5,
    desc: "Et todagerskurs for kvinner i eller nær overgangsalderen. Kari gir innsikt i kroppens fysiske endringer; Ingrid utforsker overgangsalderen som en meningsfull livsfase. Inkluderer frokost begge dager.",
